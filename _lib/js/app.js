const 
    ...
    $desktop  	  = $('.desktop'),
    $mobile  	  = $('.mobile'),
    loopUrl  	  = 'https://d125jc2jue048y.cloudfront.net/_lib/video/loop-',
    videoUrl  	  = 'https://d125jc2jue048y.cloudfront.net/_lib/video/video-',
    mvideoUrl  	  = 'https://d125jc2jue048y.cloudfront.net/_lib/video/mobile/video-',
    $header  	  = $('header'),
    $logo 	 	  = $('.logo'),
    $footer  	  = $('footer'),
    $loader  	  = $('.loader'),
